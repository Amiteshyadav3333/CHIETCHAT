      ...
      <div className="flex-1 lg:max-w-md flex flex-col items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Email or Username</label>
              <input
                type="text" required
            ...
            <div className="relative my-6 flex items-center justify-center">
              ...
              <span className="bg-[#080808] px-3 text-xs text-zinc-500 uppercase tracking-wider absolute">or</span>
            </div>

            <a
              href="https://chat.indiasearch.site"
              className="w-full bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition-all text-sm active:scale-95"
            >
              <span>Open in CHEETCHAT</span>
            </a>
          </form>
        </div>
      </div>
